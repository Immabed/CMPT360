...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure GridButtonClick(Sender: TObject; Button: TMouseButton; Shift: TShiftState; PixelX, PixelY: Integer);
  private
...
procedure TForm1.GridButtonClick(Sender: TObject; Button: TMouseButton; Shift: TShiftState; PixelX, PixelY: Integer);
var
  x, y : Whole;
  count : Integer;
begin
